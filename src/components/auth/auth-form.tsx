...
/**
 * Auth UI only — no real authentication in this frontend build.
 * On submit we simulate success and route to the dashboard.
 * Wire to Supabase Auth (signInWithPassword / signUp / OAuth) later.
 */
      ...
      <form onSubmit={onSubmit} className="space-y-4">
        {isSignup && (
          <div>
            ...
            <Input id="name" placeholder="Praewa Saetang" required />
          </div>
        )}
        <div>
