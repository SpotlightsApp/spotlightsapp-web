...
export const en = {
  ...
  auth: {
    ...
    notGranted: "This account isn't on the access list. Spotlights is invite-only during testing.",
    authError: "We couldn't complete sign-in. Please try again.",
    inviteOnlyTitle: "Invite-only access", inviteOnlyBody: "Spotlights is in private testing. New sign-ups are limited to invited accounts right now. If you should have access, reach out to the team.",
...
export const th: typeof en = {
  ...
  auth: {
    ...
    notGranted: "บัญชีนี้ไม่อยู่ในรายชื่อที่ได้รับสิทธิ์ ขณะนี้ Spotlights เปิดให้ใช้งานเฉพาะผู้ที่ได้รับเชิญเท่านั้น",
    authError: "ไม่สามารถเข้าสู่ระบบได้ กรุณาลองใหม่อีกครั้ง",
    inviteOnlyTitle: "เข้าถึงเฉพาะผู้ได้รับเชิญ", inviteOnlyBody: "ขณะนี้ Spotlights อยู่ในช่วงทดสอบแบบส่วนตัว การสมัครใหม่จำกัดเฉพาะบัญชีที่ได้รับเชิญเท่านั้น หากคุณควรมีสิทธิ์เข้าถึง โปรดติดต่อทีมงาน",
